    ...
    dojo.fx.slideTo = function(_17) {
        ...
        var _1c = (function() {
            ...
            return function() {
                ...
                top = (pos == "absolute" ? _18.offsetTop : parseInt(_19(_18).top) || 0);
                _1b = (pos == "absolute" ? _18.offsetLeft : parseInt(_19(_18).left) || 0);
...
if (!dojo._hasResource["dojo.date.stamp"]) {
    ...
    dojo.date.stamp.fromISOString = function(_25, _26) {
        ...
        if (_27) {
            ...
            if (_26) {
                _26 = new Date(_26);
                dojo.map(["FullYear", "Month", "Date", "Hours", "Minutes", "Seconds", "Milliseconds"], function(_29) {
                    return _26["get" + _29]();
            ...
            _28 = new Date(_27[0] || 1970, _27[1] || 0, _27[2] || 0, _27[3] || 0, _27[4] || 0, _27[5] || 0, _27[6] || 0);
            var _2c = 0;
    ...
    dojo.date.stamp.toISOString = function(_2e, _2f) {
        ...
        if (_2f.selector != "time") {
            _34 = [_2e[_33 + "FullYear"](), _(_2e[_33 + "Month"]() + 1), _(_2e[_33 + "Date"]())].join("-");
        }
        _32.push(_34);
        if (_2f.selector != "date") {
            var _35 = [_(_2e[_33 + "Hours"]()), _(_2e[_33 + "Minutes"]()), _(_2e[_33 + "Seconds"]())].join(":");
            ...
            if (_2f.zulu) {
                ...
                _35 += (_37 > 0 ? "-" : "+") + _(Math.floor(_38 / 60)) + ":" + _(_38 % 60);
            }
            _32.push(_35);
        }
        return _32.join("T");
    ...
    dojo.parser = new function() {
        ...
        function str2obj(_3b, _3c) {
            switch (_3c) {
                ...
                case "boolean":
                    return typeof _3b == "boolean" ? _3b : !(_3b.toLowerCase() == "false");
                case "function":
                    if (d.isFunction(_3b)) {
                        _3b = _3b.toString();
                        _3b = d.trim(_3b.substring(_3b.indexOf("{") + 1, _3b.length - 1));
                    }
                    try {
                        if (_3b.search(/[^\w\.]+/i) != -1) {
        ...
        function getClassInfo(_3e) {
            if (!_3d[_3e]) {
                ...
                if (!d.isFunction(cls)) {
                    throw new Error("Could not load class '" + _3e + "'. Did you spell the name correctly and use a full path, like 'dijit.form.Button'?");
                }
        ...
        this.instantiate = function(_51) {
            ...
            d.forEach(_51, function(_53) {
                ...
                for (var _5a in _55.params) {
                    ...
                    if (!_5b || (!_5b.specified && (!dojo.isIE || _5a.toLowerCase() != "value"))) {
                        continue;
                    }
                ...
                if (!ps) {
                    var _5d = d.query("> script[type='dojo/method'][event='preamble']", _53).orphan();
                    if (_5d.length) {
            ...
            d.forEach(_52, function(_63) {
                if (_63 && (_63.startup) && ((!_63.getParent) || (!_63.getParent()))) {
                    _63.startup();
                }
            });
            return _52;
...
if (!dojo._hasResource["dojo.dnd.container"]) {
    ...
    dojo.declare("dojo.dnd.Container", null, {
        ...
        startup: function() {
            ...
            dojo.query("> .dojoDndItem", this.parent).forEach(function(_81) {
                if (!_81.id) {
                    _81.id = dojo.dnd.getUniqueId();
                }
                var _82 = _81.getAttribute("dndType"),
                    _83 = _81.getAttribute("dndData");
                this.setItem(_81.id, {
                    data: _83 ? _83 : _81.innerHTML,
                    type: _82 ? _82.split(/\s*,\s*/) : ["text"]
                });
            }, this);
        },
        ...
        _getChildByEvent: function(e) {
            ...
            if (_91) {
                for (var _92 = _91.parentNode; _92; _91 = _92, _92 = _91.parentNode) {
                    if (_92 == this.parent && dojo.hasClass(_91, "dojoDndItem")) {
                        return _91;
                    }
                }
            }
        ...
        _normalizedCreator: function(_93, _94) {
            var t = (this.creator ? this.creator : this.defaultCreator)(_93, _94);
    ...
    dojo.dnd._defaultCreator = function(_9e) {
        ...
        return function(_a1, _a2) {
            ...
            var t = String(_a4),
                n = (_a2 == "avatar" ? dojo.dnd._createSpan : c)(t);
...
if (!dojo._hasResource["dojo.dnd.selector"]) {
    ...
    dojo.declare("dojo.dnd.Selector", dojo.dnd.Container, {
        ...
        insertNodes: function(_b2, _b3, _b4, _b5) {
            ...
            dojo.dnd.Selector.superclass.insertNodes.call(this, _b3, _b4, _b5);
            ...
            if (!this.singular && e.shiftKey) {
                ...
                if (c.length) {
                    ...
                    if (this.anchor != this.current) {
                        ...
                        for (; i < c.length; ++i) {
                            var _bf = c[i];
                            if (_bf == this.anchor || _bf == this.current) {
                                break;
                            }
                        }
                        for (++i; i < c.length; ++i) {
    ...
    dojo.extend(dojo.dnd.Avatar, {
        construct: function() {
            ...
            for (var i = 0; i < k; ++i) {
                ...
                var _e2 = _e0.creator ? _e2 = _e0._normalizedCreator(_e0.getItem(this.manager.nodes[i].id).data, "avatar").node : _e2 = this.manager.nodes[i].cloneNode(true);
                _e2.id = "";
                td.appendChild(_e2);
                tr.appendChild(td);
...
if (!dojo._hasResource["dojo.dnd.manager"]) {
    ...
    dojo.extend(dojo.dnd.Manager, {
        ...
        overSource: function(_e6) {
            if (this.avatar) {
                this.target = (_e6 && _e6.targetState != "Disabled") ? _e6 : null;
                this.avatar.update();
            }
        ...
        onMouseMove: function(e) {
            ...
            if (a) {
                ...
                var _f0 = Boolean(this.source.copyState(dojo.dnd.getCopyKeyState(e)));
                if (this.copy != _f0) {
...
if (!dojo._hasResource["dojo.dnd.source"]) {
    ...
    dojo.declare("dojo.dnd.Source", dojo.dnd.Selector, {
        ...
        constructor: function(_f7, _f8) {
            ...
            this.isSource = typeof _f8.isSource == "undefined" ? true : _f8.isSource;
            var _f9 = _f8.accept instanceof Array ? _f8.accept : ["text"];
            this.accept = null;
            if (_f9.length) {
                this.accept = {};
        ...
        onMouseMove: function(e) {
            ...
            if (this.isDragging) {
                ...
                if (this.current != this.targetAnchor || _106 != this.before) {
                ...
                if (this.mouseDown && this.isSource) {
                    ...
                    if (_107.length) {
                        m.startDrag(this, _107, this.copyState(dojo.dnd.getCopyKeyState(e)));
                    }
                }
            }
        },
        ...
        onDndStart: function(_10c, _10d, copy) {
            if (this.isSource) {
                this._changeState("Source", this == _10c ? (copy ? "Copied" : "Moved") : "");
            }
            var _10f = this.accept && this.checkAcceptance(_10c, _10d);
        ...
        onDndDrop: function(_110, _111, copy) {
            do {
                ...
                if (this != _110) {
                    if (this.creator) {
                        this._normalizedCreator = function(node, hint) {
                            return _113.call(this, _110.getItem(node.id).data, hint);
                        };
                    } else {
                        if (copy) {
                            this._normalizedCreator = function(node, hint) {
                ...
                this.insertNodes(true, _111, this.before, this.current);
                if (this != _110 && !copy && this.creator) {
        ...
        _markTargetAnchor: function(_129) {
            if (this.current == this.targetAnchor && this.before == _129) {
                return;
            }
            if (this.targetAnchor) {
...
if (!dojo._hasResource["dojo.dnd.move"]) {
    ...
    dojo.dnd.Mover = function(node, e) {
        ...
        var d = node.ownerDocument,
            _132 = dojo.connect(d, "onmousemove", this, "onFirstMove");
        this.events = [dojo.connect(d, "onmousemove", this, "onMouseMove"), dojo.connect(d, "onmouseup", this, "destroy"), dojo.connect(d, "ondragstart", dojo, "stopEvent"), dojo.connect(d, "onselectstart", dojo, "stopEvent"), _132];
...
if (!dojo._hasResource["dojo.i18n"]) {
    ...
    dojo.i18n.getLocalization = function(_152, _153, _154) {
        ...
        throw new Error("Bundle not found: " + _153 + " in " + _152 + " , locale=" + _154);
    };
...
if (!dojo._hasResource["dojo.string"]) {
    ...
    dojo.string.substitute = function(_194, map, _196, _197) {
        return _194.replace(/\$\{([^\s\:\}]+)(?:\:([^\s\:\}]+))?\}/g, function(_198, key, _19a) {
...
if (!dojo._hasResource["dojo.number"]) {
    ...
    dojo.number._applyPattern = function(_1ad, _1ae, _1af) {
        ...
        if (_1ae.indexOf("%") != -1) {
            ...
            if (_1ae.indexOf("\u2030") != -1) {
                ...
                if (_1ae.indexOf("\xa4") != -1) {
                    ...
                    _1ae = _1ae.replace(/\u00a4{1,3}/, function(_1b4) {
                        var prop = ["symbol", "currency", "displayName"][_1b4.length - 1];
        ...
        if (!_1b7) {
            throw new Error("unable to find a number expression in pattern: " + _1ae);
        }
    ...
    dojo.number._formatAbsolute = function(_1be, _1bf, _1c0) {
        ...
        var _1c1 = _1bf.split(".");
        var _1c2 = (_1c0.places >= 0) ? _1c0.places : (_1c1[1] && _1c1[1].length) || 0;
        if (!(_1c0.round < 0)) {
        ...
        var _1c4 = _1c3[1] || "";
        if (_1c0.places) {
            _1c3[1] = dojo.string.pad(_1c4.substr(0, _1c0.places), _1c0.places, "0", true);
        } else {
    ...
    dojo.number._parseInfo = function(_1d0) {
        ...
        if (_1d7) {
            re = re.replace(/(\s*)(\u00a4{1,3})(\s*)/g, function(_1e0, _1e1, _1e2, _1e3) {
                var prop = ["symbol", "currency", "displayName"][_1e2.length - 1];
                var _1e5 = dojo.regexp.escapeString(_1d0[prop] || _1d0.currency || "");
                _1e1 = _1e1 ? "\\s" : "";
                _1e3 = _1e3 ? "\\s" : "";
                if (!_1d0.strict) {
                    if (_1e1) {
    ...
    dojo.number.parse = function(_1e6, _1e7) {
        ...
        _1ea = _1ea.replace(new RegExp("[" + info.group + "\\s\\xa0" + "]", "g"), "").replace(info.decimal, ".");
    ...
    dojo.number._integerRegexp = function(_1f3) {
        ...
        var _1f6 = dojo.regexp.buildGroupRE(_1f3.separator, function(sep) {
            ...
            var grp = _1f3.groupSize,
                grp2 = _1f3.groupSize2;
            if (grp2) {
                var _1fa = "(?:0|[1-9]\\d{0," + (grp2 - 1) + "}(?:[" + sep + "]\\d{" + grp2 + "})*[" + sep + "]\\d{" + grp + "})";
                return ((grp - grp2) > 0) ? "(?:" + _1fa + "|(?:0|[1-9]\\d{0," + (grp - 1) + "}))" : _1fa;
            }
...
if (!dojo._hasResource["dojo.currency"]) {
    ...
    dojo.currency._mixInDefaults = function(_200) {
        _200 = _200 || {};
        _200.type = "currency";
        var _201 = dojo.i18n.getLocalization("dojo.cldr", "currency", _200.locale) || {};
        ...
        function createSortFunction(attr, dir) {
            return function(_217, _218) {
                ...
                if (_213.comparatorMap) {
                    ...
                    _21b = _213.comparatorMap[attr] || dojo.data.util.sorter.basicComparator;
                }
...
if (!dojo._hasResource["dojo.data.util.simpleFetch"]) {
    ...
    dojo.data.util.simpleFetch.fetch = function(_222) {
        ...
        var _228 = function(_229, _22a) {
            ...
            if (_22a.sort) {
                _229.sort(dojo.data.util.sorter.createSortFunction(_22a.sort, self));
            }
            if (_22a.onItem) {
                for (var i = _22d;
                    (i < _229.length) && (i < _22e); ++i) {
                    var item = _229[i];
                    if (!_22c) {
    ...
    dojo.declare("dojo.data.JsonItemStore", null, {
        ...
        containsValue: function(item, _242, _243) {
            ...
            if (typeof _243 === "string") {
                _244 = dojo.data.util.filter.patternToRegExp(_243, false);
            }
        ...
        _fetchItems: function(_251, _252, _253) {
            ...
            var _255 = function(_256, _257) {
                var _258 = null;
                if (_256.query) {
                    var _259 = _256.queryOptions ? _256.queryOptions.ignoreCase : false;
                    _258 = [];
                    var _25a = {};
                    for (var key in _256.query) {
                        var _25c = _256.query[key];
                        if (typeof _25c === "string") {
                            _25a[key] = dojo.data.util.filter.patternToRegExp(_25c, _259);
                        }
                    }
                    for (var i = 0; i < _257.length; ++i) {
                        ...
                        for (var key in _256.query) {
                            var _25c = _256.query[key];
                            if (!self._containsValue(_25f, key, _25c, _25a[key])) {
                                _25e = false;
                            }
                        }
                        if (_25e) {
                    ...
                    if (self._arrayOfAllItems.length > 0) {
                        _258 = self._arrayOfAllItems.slice(0, self._arrayOfAllItems.length);
                    }
                    _252(_258, _256);
                }
            };
            if (this._loadFinished) {
                ...
                if (this._jsonFileUrl) {
                    ...
                    _261.addCallback(function(data) {
                        self._loadFinished = true;
                        try {
                            self._arrayOfAllItems = self._getItemsFromLoadedData(data);
                            _255(_251, self._arrayOfAllItems);
                        } catch (e) {
                            _253(e, _251);
                        }
                    });
                    ...
                    if (this._jsonData) {
                        ...
                        _253(new Error("dojo.data.JsonItemStore: No JSON source data was provided as either URL or a nested Javascript object."), _251);
                    }
                }
            }
        },
            ...
            if (_26c) {
                ...
                for (var i = 0; i < _266.length; ++i) {
                    ...
                    if (!this._itemsByIdentity[identity]) {
                        ...
                        if (this._jsonFileUrl) {
                            throw new Error("dojo.data.JsonItemStore:  The json data as specified by: [" + this._jsonFileUrl + "] is malformed.  Items within the list have identifier: [" + _26c + "].  Value collided: [" + identity + "]");
                        } else {
                            if (this._jsonData) {
                                throw new Error("dojo.data.JsonItemStore:  The json data provided by the creation arguments is malformed.  Items within the list have identifier: [" + _26c + "].  Value collided: [" + identity + "]");
                            }
                        }
                    }
                }
            ...
            for (i = 0; i < _266.length; ++i) {
                ...
                for (key in item) {
                    ...
                    for (var j = 0; j < _26d.length; ++j) {
                        _26b = _26d[j];
                        if (_26b !== null && typeof _26b == "object" && _26b.reference) {
        ...
        fetchItemByIdentity: function(_277) {
            if (!this._loadFinished) {
                ...
                if (this._jsonFileUrl) {
                    ...
                    _27a.addCallback(function(data) {
                        var _27c = _277.scope ? _277.scope : dojo.global;
                        try {
                            self._arrayOfAllItems = self._getItemsFromLoadedData(data);
                            self._loadFinished = true;
                            var item = self._getItemByIdentity(_277.identity);
                            if (_277.onItem) {
                                _277.onItem.call(_27c, item);
                            }
                        } catch (error) {
                            if (_277.onError) {
                                _277.onError.call(_27c, error);
                            }
                        }
                    });
                    _27a.addErrback(function(_27e) {
                        if (_277.onError) {
                            var _27f = _277.scope ? _277.scope : dojo.global;
                    ...
                    if (this._jsonData) {
                        ...
                        var item = self._getItemByIdentity(_277.identity);
                        if (_277.onItem) {
                            var _281 = _277.scope ? _277.scope : dojo.global;
                            _277.onItem.call(_281, item);
                        }
                    }
                }
            } else {
                var item = this._getItemByIdentity(_277.identity);
                if (_277.onItem) {
                    var _281 = _277.scope ? _277.scope : dojo.global;
                    _277.onItem.call(_281, item);
                }
...
if (!dojo._hasResource["dojo.data.JsonItemStoreAutoComplete"]) {
    ...
    dojo.declare("dojo.data.JsonItemStoreAutoComplete", dojo.data.JsonItemStore, {
        _fetchItems: function(_28b, _28c, _28d) {
            var self = this;
            var _28f = function(_290, _291) {
                var _292 = null;
                if (_290.query) {
                    var _293 = _290.queryOptions ? _290.queryOptions.ignoreCase : false;
                    _292 = [];
                    var _294 = {};
                    for (var key in _290.query) {
                        var _296 = _290.query[key];
                        if (typeof _296 === "string") {
                            _294[key] = dojo.data.util.filter.patternToRegExp(_296, _293);
                        }
                    }
                    ...
                    if (self._arrayOfAllItems.length > 0) {
                        _292 = self._arrayOfAllItems.slice(0, self._arrayOfAllItems.length);
                    }
                    _28c(_292, _290);
                }
            };
            ...
            if (_29a) {
                if (this._jsonFileUrl) {
                    var _29c = {
                        url: self._jsonFileUrl + "?keyword=" + _29a,
                        handleAs: "json-comment-optional"
                    };
                    var _29d = dojo.xhrGet(_29c);
                    _29d.addCallback(function(data) {
                        self._loadFinished = true;
                        try {
                            self._arrayOfAllItems = self._getItemsFromLoadedData(data);
                            _28f(_28b, self._arrayOfAllItems);
                        } catch (e) {
                            _28d(e, _28b);
                        }
                    });
                    ...
                    if (this._jsonData) {
                        ...
                        _28d(new Error("dojo.data.JsonItemStoreAutoComplete: No JSON source data was provided as either URL or a nested Javascript object."), _28b);
                    }
                }
            }
        }
    ...
    dojo.mixin(dijit, {
            ...
            if (_2a1.selection) {
                ...
                if (_2a0.getSelection) {
                    ...
                    if (dojo.isString(_2a2)) {
                        ...
                        return _2a2.isCollapsed || !_2a2.toString();
                    }
                }
            }
        },
        getBookmark: function() {
            ...
            if (_2a4) {
                ...
                if (_2a4.type.toUpperCase() == "CONTROL") {
                    _2a3 = _2a5.length ? dojo._toArray(_2a5) : null;
                } else {
        ...
        moveToBookmark: function(_2a6) {
            ...
            if (_2a7.selection) {
                ...
                var _2a9 = dojo.global.getSelection && dojo.global.getSelection();
        ...
        getFocus: function(menu, _2ab) {
            return {
                ...
                bookmark: !dojo.withGlobal(_2ab || dojo.global, dijit.isCollapsed) ? dojo.withGlobal(_2ab || dojo.global, dijit.getBookmark) : null,
        ...
        focus: function(_2ac) {
            ...
            var node = "node" in _2ac ? _2ac.node : _2ac,
                _2ae = _2ac.bookmark,
                _2af = _2ac.openedForWindow;
            if (node) {
                var _2b0 = (node.tagName.toLowerCase() == "iframe") ? node.contentWindow : node;
                if (_2b0 && _2b0.focus) {
                    try {
                        _2b0.focus();
                    } catch (e) {}
            ...
            if (_2ae && dojo.withGlobal(_2af || dojo.global, dijit.isCollapsed)) {
                if (_2af) {
                    _2af.focus();
                }
                try {
                    dojo.withGlobal(_2af || dojo.global, moveToBookmark, null, [_2ae]);
                } catch (e) {}
            }
        },
        _activeStack: [],
        registerWin: function(_2b1) {
            ...
            dojo.connect(_2b1.document, "onmousedown", null, function(evt) {
            ...
            var body = _2b1.document.body || _2b1.document.getElementsByTagName("body")[0];
            if (body) {
                if (dojo.isIE) {
                ...
                while (node) {
                    if (node.dijitPopupParent) {
                        ...
                        if (node.tagName && node.tagName.toLowerCase() == "body") {
                            ...
                            node = dojo.query("iframe").filter(function(_2ba) {
        ...
        _onFocusNode: function(node) {
            ...
            if (w && w._setStateClass) {
                w._focused = true;
                w._setStateClass();
                var _2be = dojo.connect(node, "onblur", function() {
                    w._focused = false;
                    w._setStateClass();
        ...
        _setStack: function(_2bf) {
            ...
            for (var _2c1 = 0; _2c1 < Math.min(_2c0.length, _2bf.length); _2c1++) {
...
if (!dojo._hasResource["dijit._base.manager"]) {
    ...
    dijit.getUniqueId = function(_2ce) {
        var id;
        do {
            id = _2ce + "_" + (dijit._widgetTypeCtr[_2ce] !== undefined ? ++dijit._widgetTypeCtr[_2ce] : dijit._widgetTypeCtr[_2ce] = 0);
        } while (dijit.byId(id));
        return id;
    };
    if (dojo.isIE) {
...
if (!dojo._hasResource["dijit._base.place"]) {
    ...
    dijit._place = function(node, _2df, _2e0) {
        ...
        for (var i = 0; i < _2df.length; i++) {
            ...
            var _2e9 = (_2e4.charAt(1) == "L" ? pos.x : Math.max(view.l, pos.x - mb.w)),
                _2ea = (_2e4.charAt(0) == "T" ? pos.y : Math.max(view.t, pos.y - mb.h)),
                endX = (_2e4.charAt(1) == "L" ? Math.min(view.l + view.w, _2e9 + mb.w) : pos.x),
                endY = (_2e4.charAt(0) == "T" ? Math.min(view.t + view.h, _2ea + mb.h) : pos.y),
                _2ed = endX - _2e9,
                _2ee = endY - _2ea,
                _2ef = (mb.w - _2ed) + (mb.h - _2ee);
...
if (!dojo._hasResource["dijit._base.popup"]) {
    ...
    dijit.popup = new function() {
        ...
        this.open = function(args) {
            var _303 = args.popup,
                ...
                _305 = args.around,
                id = (args.around && args.around.id) ? (args.around.id + "_dropdown") : ("popup_" + _301++);
            if (!args.submenu) {
                this.closeAll();
            }
            ...
            var best = _305 ? dijit.placeOnScreenAroundElement(_307, _305, _304, _303.orient ? dojo.hitch(_303, "orient") : null) : dijit.placeOnScreen(_307, args, _304 == "R" ? ["TR", "BR", "TL", "BL"] : ["TL", "BL", "TR", "BR"]);
            var _30a = [];
            ...
            _30a.push(dojo.connect(_303, _303.onExecute ? "onExecute" : "onChange", null, function() {
    ...
    dijit.BackgroundIframe = function(node) {
        ...
        if ((dojo.isIE && dojo.isIE < 7) || (dojo.isFF && dojo.isFF < 3 && dojo.hasClass(dojo.body(), "dijit_a11y"))) {
            ...
            if (dojo.isIE) {
                _318.style.setExpression("width", "document.getElementById('" + node.id + "').offsetWidth");
                _318.style.setExpression("height", "document.getElementById('" + node.id + "').offsetHeight");
            }
            this.iframe = _318;
        }
    };
    ...
    dijit.typematic = {
        ...
        addKeyListener: function(node, _32c, _32d, _32e, _32f, _330) {
            ...
            ary.push(dojo.connect(node, "onkeypress", this, function(evt) {
                if (evt.keyCode == _32c.keyCode && (!_32c.charCode || _32c.charCode == evt.charCode) && ((typeof _32c.ctrlKey == "undefined") || _32c.ctrlKey == evt.ctrlKey) && ((typeof _32c.altKey == "undefined") || _32c.altKey == evt.ctrlKey) && ((typeof _32c.shiftKey == "undefined") || _32c.shiftKey == evt.ctrlKey)) {
                    dojo.stopEvent(evt);
                    dijit.typematic.trigger(_32c, _32d, node, _32e, _32c, _32f, _330);
                } else {
        ...
        addMouseListener: function(node, _335, _336, _337, _338) {
            ...
            ary.push(dojo.connect(node, "mousedown", this, function(evt) {
                dojo.stopEvent(evt);
                dijit.typematic.trigger(evt, _335, node, _336, node, _337, _338);
            }));
        ...
        addListener: function(_33f, _340, _341, _342, _343, _344, _345) {
            return this.addKeyListener(_340, _341, _342, _343, _344, _345).concat(this.addMouseListener(_33f, _342, _343, _344, _345));
        }
    };
}
if (!dojo._hasResource["dijit._base.wai"]) {
    ...
    dijit.wai = {
        ...
        setAttr: function(node, ns, attr, _349) {
            if (dojo.isIE) {
                node.setAttribute(this[ns].alias + ":" + attr, this[ns].prefix + _349);
            } else {
                node.setAttributeNS(this[ns]["namespace"], attr, this[ns].prefix + _349);
            }
        },
        ...
        onload: function() {
            ...
            function check() {
                ...
                if (cs) {
                    ...
                    var _354 = (cs.borderTopColor == cs.borderRightColor) || (_353 != null && (_353 == "none" || _353 == "url(invalid-url:)"));
                    dojo[_354 ? "addClass" : "removeClass"](dojo.body(), "dijit_a11y");
                }
            };
            check();
            if (dojo.isIE) {
        ...
        connect: function(obj, _360, _361) {
            ...
            if (_360 == "ondijitclick") {
                ...
                if (!this.nodesWithKeyClick[obj.nodeName]) {
                    _362.push(dojo.connect(obj, "onkeydown", this, function(e) {
                        if (e.keyCode == dojo.keys.ENTER) {
                            return (dojo.isString(_361)) ? w[_361](e) : _361.call(w, e);
                        } else {
                    ...
                    _362.push(dojo.connect(obj, "onkeyup", this, function(e) {
                        if (e.keyCode == dojo.keys.SPACE) {
                            return dojo.isString(_361) ? w[_361](e) : _361.call(w, e);
                        }
                    }));
...
if (!dojo._hasResource["dijit._Templated"]) {
    ...
    dojo.declare("dijit._Templated", null, {
        ...
        containerNode: null,
        buildRendering: function() {
            var _368 = dijit._Templated.getCachedTemplate(this.templatePath, this.templateString);
            var node;
            if (dojo.isString(_368)) {
                var _36a = this.declaredClass,
                    _36b = this;
                var tstr = dojo.string.substitute(_368, this, function(_36d, key) {
                    if (key.charAt(0) == "!") {
                    ...
                    return key.charAt(0) == "!" ? _36d : _36d.toString().replace(/"/g, "&quot;");
                }, this);
        ...
        _attachTemplateNodes: function(_374, _375) {
            ...
            var _378 = dojo.isArray(_374) ? _374 : (_374.all || _374.getElementsByTagName("*"));
    ...
    dijit._Templated.getCachedTemplate = function(_38b, _38c) {
        ...
        if (!_38c) {
            _38c = dijit._Templated._sanitizeTemplateString(dojo._getText(_38b));
        }
    ...
    dijit._Templated._sanitizeTemplateString = function(_390) {
        if (_390) {
            _390 = _390.replace(/^\s*<\?xml(\s)+version=[\'\"](\d)*.(\d)*[\'\"](\s)*\?>/im, "");
    ...
    if (dojo.isIE) {
        ...
        dijit._Templated._createNodesFromText = function(text) {
            ...
            var _39d = (typeof tag != "undefined") ? tn.getElementsByTagName(tag)[0] : tn;
            var _39e = [];
...
if (!dojo._hasResource["dijit._tree.Controller"]) {
    ...
    dojo.declare("dijit._tree.Controller", [dijit._Widget], {
        treeId: "",
        postMixInProperties: function() {
        ...
        _listener: function(_3ac) {
            var _3ad = _3ac.event;
            var _3ae = "on" + _3ad.charAt(0).toUpperCase() + _3ad.substr(1);
            if (this[_3ae]) {
                this[_3ae](_3ac);
            }
        },
        ...
        onExecute: function(_3b0) {
            ...
            console.log("execute message for " + _3b0.node + ": ", _3b0);
        },
        ...
        onNew: function(item, _3b4) {
            if (_3b4) {
                var _3b5 = this._itemNodeMap[this.store.getIdentity(_3b4.item)];
            }
            var _3b6 = {
                item: item
            };
        ...
        onPrevious: function(_3c0) {
            ...
            if (_3c3) {
                _3c1 = _3c3;
                while (_3c1.isFolder && _3c1.isExpanded && _3c1.hasChildren()) {
                    _3c2 = _3c1;
        ...
        onAfterTreeCreate: function(_3dc) {
            ...
            function onComplete(_3df) {
                var _3e0 = dojo.map(_3df, function(item) {
                    return {
                        item: item,
                        isFolder: _3de.store.hasAttribute(item, _3de.childrenAttr)
                    };
                });
...
if (!dojo._hasResource["dijit.Tree"]) {
    ...
    dojo.declare("dijit._TreeBase", [dijit._Widget, dijit._Templated, dijit._Container, dijit._Contained], {
        state: "UNCHECKED",
        locked: false,
        lock: function() {
            this.locked = true;
    ...
    dojo.declare("dijit.Tree", dijit._TreeBase, {
        store: null,
        query: null,
        ...
        _onClick: function(e) {
            ...
            if (_40b == _40c.expandoNode || _40b == _40c.expandoNodeText) {
                if (_40c.isFolder) {
        ...
        _onKeyPress: function(e) {
            ...
            if (e.charCode) {
                ...
                if (!e.altKey && !e.ctrlKey && !e.shiftKey && !e.metaKey) {
                    _410 = (String.fromCharCode(_410)).toLowerCase();
    ...
    dojo.declare("dijit._TreeNode", dijit._TreeBase, {
        ...
        _setExpando: function(_417) {
            var _418 = ["dijitTreeExpandoLoading", "dijitTreeExpandoOpened", "dijitTreeExpandoClosed", "dijitTreeExpandoLeaf"];
            var idx = _417 ? 0 : (this.isFolder ? (this.isExpanded ? 1 : 2) : 3);
            dojo.forEach(_418, function(s) {
                dojo.removeClass(this.expandoNode, s);
            }, this);
            dojo.addClass(this.expandoNode, _418[idx]);
            this.expandoNodeText.innerHTML = _417 ? "*" : (this.isFolder ? (this.isExpanded ? "-" : "+") : "*");
        },
        ...
        setLabelNode: function(_41d) {
            this.labelNode.innerHTML = "";
            this.labelNode.appendChild(document.createTextNode(_41d));
        },
        toString: function() {
...
if (!dojo._hasResource["dijit.layout.ContentPane"]) {
    ...
    dojo.declare("dijit.layout.ContentPane", dijit._Widget, {
        ...
        postCreate: function() {
            ...
            var _41e = dojo.i18n.getLocalization("dijit", "loading", this.lang);
            this.loadingMessage = dojo.string.substitute(this.loadingMessage, _41e);
            this.errorMessage = dojo.string.substitute(this.errorMessage, _41e);
        ...
        _loadCheck: function(_423) {
            ...
            if (this.href && (_423 || (this.preload && !this._xhrDfd) || (this.refreshOnShow && _424 && !this._xhrDfd) || (!this.isLoaded && _424 && !this._xhrDfd))) {
        ...
        _downloadExternalContent: function() {
            ...
            var hand = this._xhrDfd = (this.ioMethod || dojo.xhrGet)(_426);
        ...
        _onError: function(type, err, _430) {
            var _431 = this["on" + type + "Error"].call(this, err);
            if (_430) {
    ...
    dojo.declare("dijit.form._FormMixin", null, {
        ...
        setValues: function(obj) {
            ...
            dojo.forEach(this.getDescendants(), function(_43b) {
                ...
                var _43c = map[_43b.name] || (map[_43b.name] = []);
                _43c.push(_43b);
            });
            for (var name in map) {
                var _43e = map[name],
                    _43f = dojo.getObject(name, false, obj);
                if (!dojo.isArray(_43f)) {
                    _43f = [_43f];
                }
                if (_43e[0].setChecked) {
                    dojo.forEach(_43e, function(w, i) {
                        w.setChecked(dojo.indexOf(_43f, w.value) != -1);
                    });
                } else {
                    dojo.forEach(_43e, function(w, i) {
                        w.setValue(_43f[i]);
        ...
        getValues: function() {
            ...
            dojo.forEach(this.getDescendants(), function(_445) {
                var _446 = _445.getValue ? _445.getValue() : _445.value;
                var name = _445.name;
                if (!name) {
                    return;
                }
        ...
        isValid: function() {
            return dojo.every(this.getDescendants(), function(_449) {
...
if (!dojo._hasResource["dijit.Dialog"]) {
    ...
    dojo.declare("dijit.Dialog", [dijit.layout.ContentPane, dijit._Templated, dijit.form._FormMixin], {
        templateString: null,
    ...
    dojo.declare("dijit.TooltipDialog", [dijit.layout.ContentPane, dijit._Templated, dijit.form._FormMixin], {
        title: "",
        _lastFocusItem: null,
        templateString: null,
        ...
        orient: function(_458) {
            this.domNode.className = "dijitTooltipDialog " + " dijitTooltipAB" + (_458.charAt(1) == "L" ? "Left" : "Right") + " dijitTooltip" + (_458.charAt(0) == "T" ? "Below" : "Above");
        },
        onOpen: function(pos) {
...
if (!dojo._hasResource["dijit.form._FormWidget"]) {
    ...
    dojo.declare("dijit.form._FormWidget", [dijit._Widget, dijit._Templated], {
        ...
        setDisabled: function(_45d) {
            ...
            dijit.wai.setAttr(this.focusNode || this.domNode, "waiState", "disabled", _45d);
            this._setStateClass();
        },
            ...
            if (!this.disabled) {
                switch (_45e.type) {
                    case "mouseover":
                        this._hovering = true;
                        var _460, node = _45f;
                        while (node.nodeType === 1 && !(_460 = node.getAttribute("baseClass")) && node != this.domNode) {
                            node = node.parentNode;
                        }
                        this.baseClass = _460 || "dijit" + this.declaredClass.replace(/.*\./g, "");
                        break;
                    case "mouseout":
                        this._hovering = false;
                        this.baseClass = null;
                    ...
                    case "mousedown":
                        this._active = true;
                        var self = this;
                        var _463 = this.connect(dojo.body(), "onmouseup", function() {
                            self._active = false;
                            self._setStateClass();
        ...
        _setStateClass: function(base) {
            ...
            _465 = _465.replace(new RegExp("\\b" + base + "(Checked)?(Selected)?(Disabled|Active|Focused|Hover)?\\b\\s*", "g"), "");
            var _466 = [base];
            ...
            }(this.styleNode || this.domNode).className = _465 + " " + _466.join(" ");
        },
        ...
        setValue: function(_46a, _46b) {
            ...
            if ((this.intermediateChanges || _46b) && _46a != this._lastValueReported) {
    ...
    dojo.declare("dijit.form.Button", dijit.form._FormWidget, {
        ...
        postCreate: function() {
            if (this.showLabel == false) {
                ...
                _470 = dojo.trim(this.containerNode.innerText || this.containerNode.textContent);
    ...
    dojo.declare("dijit.form.DropDownButton", [dijit.form.Button, dijit._Container], {
        ...
        _fillContent: function() {
            if (this.srcNodeRef) {
                ...
                dijit.form.DropDownButton.superclass._fillContent.call(this, _477[0]);
                this.dropDownContainer = this.srcNodeRef;
            }
        },
        startup: function() {
            if (!this.dropDown) {
                var _478 = dojo.query("[widgetId]", this.dropDownContainer)[0];
        ...
        _toggleDropDown: function() {
            ...
            if (!_47b.isShowingNow) {
                if (_47b.href && !_47b.isLoaded) {
                    var self = this;
                    var _47d = dojo.connect(_47b, "onLoad", function() {
        ...
        _openDropDown: function() {
            ...
            if (this.domNode.offsetWidth > _47e.domNode.offsetWidth) {
                ...
                if (!this.isLeftToRight()) {
                    ...
                    var _482 = _481.offsetLeft + _481.offsetWidth;
                }
                dojo.marginBox(_47e.domNode, {
                    w: this.domNode.offsetWidth
                });
                if (_481) {
                    _481.style.left = _482 - this.domNode.offsetWidth + "px";
                }
            }
    ...
    dojo.declare("dojo.data.ItemFileReadStore", null, {
            ...
            if (!this._datatypeMap["Date"]) {
                this._datatypeMap["Date"] = {
                    ...
                    deserialize: function(_486) {
                        return dojo.date.stamp.fromISOString(_486);
                    }
                };
            }
            this._features = {
        ...
        containsValue: function(item, _495, _496) {
            ...
            if (typeof _496 === "string") {
                _497 = dojo.data.util.filter.patternToRegExp(_496, false);
            }
        ...
        _fetchItems: function(_4a4, _4a5, _4a6) {
            ...
            var _4a8 = function(_4a9, _4aa) {
                var _4ab = [];
                if (_4a9.query) {
                    var _4ac = _4a9.queryOptions ? _4a9.queryOptions.ignoreCase : false;
                    var _4ad = {};
                    for (var key in _4a9.query) {
                        var _4af = _4a9.query[key];
                        if (typeof _4af === "string") {
                            _4ad[key] = dojo.data.util.filter.patternToRegExp(_4af, _4ac);
                        }
                    }
                    for (var i = 0; i < _4aa.length; ++i) {
                        ...
                        if (_4b2 === null) {
                            ...
                            for (var key in _4a9.query) {
                                var _4af = _4a9.query[key];
                                if (!self._containsValue(_4b2, key, _4af, _4ad[key])) {
                                    _4b1 = false;
                                }
                            }
                        }
            ...
            if (this._loadFinished) {
                _4a8(_4a4, this._getItemsArray(_4a4.queryOptions));
            } else {
                if (this._jsonFileUrl) {
                    if (this._loadInProgress) {
                        ...
                        _4b5.addCallback(function(data) {
                            try {
                                self._getItemsFromLoadedData(data);
                                self._loadFinished = true;
                                self._loadInProgress = false;
                                _4a8(_4a4, self._getItemsArray(_4a4.queryOptions));
                    ...
                    if (this._jsonData) {
                        ...
                        _4a6(new Error("dojo.data.ItemFileReadStore: No JSON source data was provided as either URL or a nested Javascript object."), _4a4);
                    }
                }
            }
        },
        _handleQueuedFetches: function() {
            if (this._queuedFetches.length > 0) {
                for (var i = 0; i < this._queuedFetches.length; i++) {
                    ...
                    if (_4bb) {
                        _4bb(_4ba, this._getItemsArray(_4ba.queryOptions));
                    } else {
        ...
        _getItemsFromLoadedData: function(_4be) {
            function valueIsAnItem(_4bf) {
                var _4c0 = ((_4bf != null) && (typeof _4bf == "object") && (!dojo.isArray(_4bf)) && (!dojo.isFunction(_4bf)) && (_4bf.constructor == Object) && (typeof _4bf._reference == "undefined") && (typeof _4bf._type == "undefined") && (typeof _4bf._value == "undefined"));
                return _4c0;
            };
            var self = this;
            ...
            if (_4ce) {
                ...
                for (i = 0; i < this._arrayOfAllItems.length; ++i) {
                    ...
                    if (!this._itemsByIdentity[_4cf]) {
                        ...
                        if (this._jsonFileUrl) {
                            throw new Error("dojo.data.ItemFileReadStore:  The json data as specified by: [" + this._jsonFileUrl + "] is malformed.  Items within the list have identifier: [" + _4ce + "].  Value collided: [" + _4cf + "]");
                        } else {
                            if (this._jsonData) {
                                throw new Error("dojo.data.ItemFileReadStore:  The json data provided by the creation arguments is malformed.  Items within the list have identifier: [" + _4ce + "].  Value collided: [" + _4cf + "]");
                            }
                        }
                    }
                }
            ...
            for (i = 0; i < this._arrayOfAllItems.length; ++i) {
                ...
                for (key in item) {
                    ...
                    for (var j = 0; j < _4cd.length; ++j) {
                        _4cc = _4cd[j];
                        if (_4cc !== null && typeof _4cc == "object") {
                            if (_4cc._type && _4cc._value) {
                                ...
                                if (!_4d2) {
                                    ...
                                    if (dojo.isFunction(_4d2)) {
                                        _4cd[j] = new _4d2(_4cc._value);
                                    } else {
                                        if (dojo.isFunction(_4d2.deserialize)) {
                                            _4cd[j] = _4d2.deserialize(_4cc._value);
                                        } else {
            ...
            if (!this._loadFinished) {
                ...
                if (this._jsonFileUrl) {
                    if (this._loadInProgress) {
                        ...
                        _4de.addCallback(function(data) {
                            var _4e0 = _4db.scope ? _4db.scope : dojo.global;
                            try {
                                self._getItemsFromLoadedData(data);
                                self._loadFinished = true;
                                self._loadInProgress = false;
                                var item = self._getItemByIdentity(_4db.identity);
                                if (_4db.onItem) {
                                    _4db.onItem.call(_4e0, item);
                                }
                                self._handleQueuedFetches();
                            } catch (error) {
                                self._loadInProgress = false;
                                if (_4db.onError) {
                                    _4db.onError.call(_4e0, error);
                                }
                            }
                        });
                        _4de.addErrback(function(_4e2) {
                            self._loadInProgress = false;
                            if (_4db.onError) {
                                var _4e3 = _4db.scope ? _4db.scope : dojo.global;
                                _4db.onError.call(_4e3, _4e2);
                            }
                        });
                    }
                } else {
                    if (this._jsonData) {
                        ...
                        var item = self._getItemByIdentity(_4db.identity);
                        if (_4db.onItem) {
                            var _4e5 = _4db.scope ? _4db.scope : dojo.global;
                            _4db.onItem.call(_4e5, item);
                        }
                    }
                }
            } else {
                var item = this._getItemByIdentity(_4db.identity);
                if (_4db.onItem) {
                    var _4e5 = _4db.scope ? _4db.scope : dojo.global;
                    _4db.onItem.call(_4e5, item);
                }
    ...
    dojo.declare("dijit.form._DropDownTextBox", null, {
        ...
        makePopup: function() {
            ...
            function _createNewPopup() {
                ...
                var _4f1 = dojo.getObject(_4ef._popupClass, false);
                return new _4f1(_4ef._popupArgs, node);
            };
            if (!this._popupWidget) {
                if (this._hasMasterPopup) {
                    var _4f2 = dojo.getObject(this.declaredClass, false);
        ...
        _showResultList: function() {
            this._hideResultList();
            var _4f5 = this._popupWidget.getListLength ? this._popupWidget.getItems() : [this._popupWidget.domNode];
            if (_4f5.length) {
                var _4f6 = Math.min(_4f5.length, this.maxListLength);
                ...
                var best = this.open();
                var _4f8 = dojo.marginBox(this._popupWidget.domNode);
                this._popupWidget.domNode.style.overflow = ((best.h == _4f8.h) && (best.w == _4f8.w)) ? "hidden" : "auto";
    ...
    dojo.declare("dijit.form.TextBox", dijit.form._FormWidget, {
        ...
        setValue: function(_4fb, _4fc, _4fd) {
            ...
            if (typeof _4fd == "undefined") {
                _4fd = (typeof _4fb == "undefined" || _4fb == null || _4fb == NaN) ? null : this.format(_4fb, this.constraints);
            }
            if (_4fd != null) {
                var _4fe = this;
                this.textbox.value = _4fd;
            }
            dijit.form.TextBox.superclass.setValue.call(this, _4fb, _4fc);
        },
        forWaiValuenow: function() {
...
if (!dojo._hasResource["dijit.Tooltip"]) {
    ...
    dojo.declare("dijit._MasterTooltip", [dijit._Widget, dijit._Templated], {
        ...
        show: function(_505, _506) {
            ...
            var pos = dijit.placeOnScreenAroundElement(this.domNode, _506, _507);
    ...
    dojo.declare("dijit.Tooltip", dijit._Widget, {
        ...
        postCreate: function() {
            ...
            dojo.forEach(["onMouseOver", "onHover", "onMouseOut", "onUnHover"], function(_509) {
                this.connect(this._connectNode, _509.toLowerCase(), "_" + _509);
            }, this);
        },
...
if (!dojo._hasResource["dijit.form.ValidationTextBox"]) {
    ...
    dojo.declare("dijit.form.ValidationTextBox", dijit.form.TextBox, {
        ...
        validator: function(_50f, _510) {
            return (new RegExp("^(" + this.regExpGen(_510) + ")" + (this.required ? "" : "?") + "$")).test(_50f) && (!this.required || !this._isEmpty(_50f));
        },
        ...
        validate: function(_515) {
            ...
            if (!dojo.hasClass(this.nodeWithBorder, "dijitInputFieldValidation" + _518)) {
                dojo.removeClass(this.nodeWithBorder, "dijitInputFieldValidation" + ((_518 == "Normal") ? "Error" : "Normal"));
                dojo.addClass(this.nodeWithBorder, "dijitInputFieldValidation" + _518);
            }
            dijit.wai.setAttr(this.focusNode, "waiState", "invalid", (_517 ? "false" : "true"));
            if (_515) {
    ...
    dojo.declare("dijit.form.RangeBoundTextBox", dijit.form.MappedTextBox, {
        ...
        rangeCheck: function(_526, _527) {
            ...
            if (_528 || _529) {
                return (!_528 || this.compare(_526, _527.min) >= 0) && (!_529 || this.compare(_526, _527.max) <= 0);
            } else {
                return true;
            }
        },
        ...
        isValid: function(_52b) {
            return this.inherited("isValid", arguments) && ((this._isEmpty(this.textbox.value) && !this.required) || this.isInRange(_52b));
        },
        getErrorMessage: function(_52c) {
            if (dijit.form.RangeBoundTextBox.superclass.isValid.call(this, false) && !this.isInRange(_52c)) {
...
if (!dojo._hasResource["dijit.form.ComboBox"]) {
    ...
    dojo.declare("dijit.form.ComboBoxMixin", dijit.form._DropDownTextBox, {
        pageSize: 30,
        store: null,
        query: {},
        autoComplete: true,
        ...
        _setSelectedRange: function(_533, _534, end) {
            ...
            if (_533.setSelectionRange) {
                ...
                if (_533.createTextRange) {
                    ...
                    _533.blur();
                    dijit.focus(_533);
                    var dist = parseInt(_533.value.length) - end;
        ...
        onkeypress: function(evt) {
            ...
            switch (evt.keyCode) {
                ...
                case dojo.keys.ENTER:
                    if (this._isShowingNow) {
                        var _53e = this._popupWidget.getHighlightedOption();
        ...
        _openResultList: function(_541, _542) {
            if (this.disabled || _542.query[this.searchAttr] != this._lastQuery) {
                return;
            }
            ...
            var _543 = new String(this.store.getValue(_541[0], this.searchAttr));
            if (_543 && (this.autoComplete) && (!this._prev_key_backspace) && (_542.query[this.searchAttr] != "*")) {
                this._autoCompleteText(_543);
                dijit.wai.setAttr(this.focusNode || this.domNode, "waiState", "valuenow", _543);
            }
            this._popupWidget.createOptions(_541, _542, dojo.hitch(this, this._getMenuLabelFromItem));
            this._showResultList();
        },
        onfocus: function() {
        ...
        _announceOption: function(node) {
            ...
            if (node == this._popupWidget.nextButton || node == this._popupWidget.previousButton) {
                ...
                _545 = this.store.getValue(node.item, this.searchAttr);
            }
        ...
        _startSearch: function(key) {
            ...
            this._nextSearch = this._popupWidget.onPage = dojo.hitch(this, nextSearch, _54b);
        },
        ...
        postMixInProperties: function() {
            ...
            if (!this.store) {
                var _54e = dojo.query("> option", this.srcNodeRef).map(function(node) {
                    node.style.display = "none";
                    return {
                ...
                if (_54e && _54e.length && !this.value) {
                    this.value = _54e[this.srcNodeRef.selectedIndex != -1 ? this.srcNodeRef.selectedIndex : 0][this._getValueField()];
                }
            }
    ...
    dojo.declare("dijit.form._ComboBoxMenu", [dijit._Widget, dijit._Templated], {
        templateString: "<div class='dijitMenu' dojoAttachEvent='onclick,onmouseover,onmouseout' tabIndex='-1' style='display:none; position:absolute; overflow:\"auto\";'>" + "<div class='dijitMenuItem' dojoAttachPoint='previousButton'></div>" + "<div class='dijitMenuItem' dojoAttachPoint='nextButton'></div>" + "</div>",
        ...
        _createOption: function(item, _555) {
            ...
            if (_556.html) {
                ...
                _557.appendChild(document.createTextNode(_556.label));
            }
            if (_557.innerHTML == "") {
                _557.innerHTML = "&nbsp;";
            }
        ...
        createOptions: function(_558, _559, _55a) {
            ...
            dojo.forEach(_558, function(item) {
                ...
                _55b.domNode.insertBefore(_55d, _55b.nextButton);
            });
            this.nextButton.style.display = _559.count == _558.length ? "" : "none";
        },
        ...
        _page: function(up) {
            ...
            var _566 = parseInt(dojo.getComputedStyle(this.domNode).height);
            if (!this.getHighlightedOption()) {
...
CalendarDateSelect.prototype = {
    ...
    refreshCalendarGrid: function() {
        ...
        for (var cell_index = 0; cell_index < 42; cell_index++) {
            ...
            if (vdc) {
                if (vdc(iterator.stripTime())) cell.removeClassName("disabled");
                else cell.addClassName("disabled")
            };
...
opentaps.makeDropTarget = function( /* String */ elementId) {
    return new dojo.dnd.Source(elementId, {
...
opentaps.formatCurrency = function( /* Number */ amount, /* String */ currencyUomId, /* String */ localex) {
    ...
    if (localex != null) {
        ...
        return dojo.currency.format(amount, {
...
opentaps.swapStatesInDropdown = function(countryElement, stateElementName) {
    ...
    opentaps.sendRequest(
        ...
        function(data) {
            opentaps.swapStatesInDropdownResponse(stateElement, data)
        }
    );
}
...
opentaps.swapStatesInDropdownResponse = function(stateElement, states) {
    ...
    stateElement.options[0] = new Option('N/A', '_NA_'); // first element is always empty
    //modified by veera
    if (states.length > 0) {
        ...
        //stateElement.options[0] = new Option('---Select---','');
        stateElement.options[0] = new Option('N/A', '_NA_');
...
opentaps.getPhoneFieldsFromVoIPCall = function( /* Element */ formElement, /* Array */ countryCodeFields, /* Array */ areaCodeFields, /* Array */ numberFields) {
    opentaps.sendRequest("getCurrentIncomingNumberFromVoIPServer", {}, function(data) {
        opentaps.populatePhoneFieldsFromVoIPCall(formElement, countryCodeFields, areaCodeFields, numberFields, data)
    });
}
...
opentaps.getCurrentPage = function(paginatorName, appName, responseFunction) {
    ...
    opentaps.sendRequest('paginate', {
        'paginatorName': paginatorName,
        'action': 'getCurrentPage',
        'applicationName': appName
    }, function(data) {
        responseFunction(paginatorName, data)
    }, {
        target: 'paginate_' + paginatorName,
        containerClass: 'paginate_' + paginatorName,
        size: 28
    });
}
...
opentaps.changePaginationOrder = function(paginatorName, appName, orderBy, orderByReverse, responseFunction) {
    if (!responseFunction) responseFunction = opentaps.processPaginationResponse;
    opentaps.sendRequest('changePaginationOrder', {
        'paginatorName': paginatorName,
        'orderBy': orderBy,
...
opentaps.changePaginationViewSize = function(paginatorName, appName, delta, responseFunction) {
    if (!responseFunction) responseFunction = opentaps.processPaginationResponse;
    opentaps.sendRequest('changePaginationViewSize', {
        'paginatorName': paginatorName,
        'delta': delta,
        'applicationName': appName
    }, function(data) {
...
opentaps.initInputAutoCompleteQuick = function( /* String */ jsonItemStoreUrl, /* String */ elementName, /* String */ elementId, /* String */ defaultValue) {
    var store = new dojo.data.JsonItemStoreAutoComplete({
        url: jsonItemStoreUrl
    });
...
opentaps.makeOutgoingCall = function( /* String */ partyIdTo, /* String */ contactMechIdTo) {
    opentaps.sendRequest("makeOutgoingCall", {
        'internalPartyId': partyIdTo,
...
opentaps.checkUploadFile = function(form, orderId, fileName, confirmMessage) {
    ...
    opentaps.sendRequest('checkExistOrderContentJSON', requestData, function(data) {
        opentaps.checkUploadFileResponse(form, confirmMessage, data)
    });
}
...
opentaps.checkSupplierProduct = function(button, productId, partyId, currencyUomId, quantity, confirmMessage, disallowVirtual) {
    ...
    opentaps.sendRequest('checkExistSupplierProductJSON', requestData, function(data) {
        opentaps.checkSupplierProductResponse(button, confirmMessage, disallowVirtual, data)
    });
}
...
function ajaxUpdateArea(areaId, target, targetParams) {
    new Ajax.Updater(areaId, target, {
...
function ajaxUpdateAreaPeriodic(areaId, target, targetParams, interval) {
    new Ajax.PeriodicalUpdater(areaId, target, {
        parameters: targetParams,
        frequency: interval
    });
}
...
function ajaxAutoCompleter(areaCsvString) {
    ...
    for (var i = 0; i < numAreas * 3; i = i + 3) {
        ...
        $(areaArray[i]).insert({
            after: '<div class="autocomplete"' + 'id=' + optionsDivId + '></div>'
        });
        new Ajax.Autocompleter($(areaArray[i]), optionsDivId, areaArray[i + 1], {
            parameters: areaArray[i + 2]
        });
    }
}
...
function ajaxAutoCompleteDropDown(descriptionElement, hiddenElement, data, options) {
    ...
    $(descriptionElement).insert({
        after: '<div class="autocomplete"' + 'id=' + update + '></div>'
    });
    new Autocompleter.Local($(descriptionElement), update, $H(data), {
        autoSelect: options.autoSelect,
        frequency: options.frequency,
        minChars: options.minChars,
        choices: options.choices,
        partialSearch: options.partialSearch,
        partialChars: options.partialChars,
        ignoreCase: options.ignoreCase,
        fullSearch: options.fullSearch,
        afterUpdateElement: setKeyAsParameter
    });
...
// added by Gnanakumar
function call_fieldlookup_webMail(target, viewName) {
    var fieldLookup = new fieldLookup1(target, arguments);
    fieldLookup.popup2(viewName);
    document.writeEmailForm.custRequestId.focus();
}
//end added by Gnanakumar
...
opentaps.expandCollapse = function( /* Object */ target, /* Object */ targetControl, /* Boolean */ forceOpen, /* Boolean */ forceClosed) {
    ...
    if (save) {
        ...
        opentaps.sendRequest('persistViewExpansionState', {
            'domId': target.id,
            "application": applicationName,
            "screenName": screenName,
            'viewState': open ? 'closed' : 'open'
        });
    }
    return target.anim;
}
...
opentaps.addOnLoad(function() {
    opentaps.addListenerToNode(document.body, 'onclick', opentaps.expansionListener)
});
/*
 * Copyright (c) Open Source Strategies, Inc.
 *
...
function displayPartyName(elementId) {
    var partyId = document.getElementById(elementId).value;
    var actualPartyInputELEId = elementId.substring("ComboBox_".length, elementId.length);
    var actualPartyId = getPartyIdFromCompositeName(partyId);
    if (actualPartyId != null) {
        document.getElementById(actualPartyInputELEId).value = actualPartyId;
        if (actualPartyId != "") {
            var requestData = {
                'partyId': actualPartyId
            };
            opentaps.sendRequest('getPartyMemberRelatedsJSON', requestData, function(data) {
                if (data.name != null) {
                    document.getElementById('displaySpan_' + actualPartyInputELEId).innerHTML = "<b><font color='green'>" + data.name + "</font></b>";
                } else {
                    document.getElementById('displaySpan_' + actualPartyInputELEId).innerHTML = "";
                }
            });
        }
    }
...
function getPartyIdFromCompositeName(name) {
    if (name.indexOf("(") > 0 && name.indexOf(")") > 0) {
        var partyId = name.substring(name.indexOf("(") + 1, name.indexOf(")"));
        return partyId;
    } else {
        return name;
    }
