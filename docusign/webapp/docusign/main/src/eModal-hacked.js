 ...
 * Licensed under MIT.
 * hacked by justin@fluidnotions.com
 * ======================================================================== */
...
module.exports = function(){
        ...
        function functionsendMessageToIFrameChild(dataObj) {
            var dataStr = JSON.stringify(data);
            console.log("sendMessageToIFrameChild: " + dataStr);
            window.dsproxychildifrmel.postMessage(dataStr, "*");
        }
        ...
        /**
           * @returns {Promise} Promise with modal $DOM element
           */
          function startSignAndSendDialogCustom(config) {
              var submitted = false;
              var dfd = _createDeferred();
              var params = {
                  deferred: dfd
              };
              var submitActionArgs = config.submitActionArgs;
              delete  config.submitActionArgs;
              var submitAction = config.submitAction;
              delete config.submitAction;
        ...
        return {
          ...
          startSignAndSendDialogCustom: startSignAndSendDialogCustom
