...
<iframe id="frame" src="/docusign/docusign.html?loginKey=${loginUrlKey}&debug=true&admin=true" class="embed-responsive-item" frameborder=0 scrolling="no" style="width:100%;height:200vh;display:block;overflow:hidden;"></iframe>
</@frameSection>
